...
int main()
{
    ...
    //VideoCapture video("D:/opencv资料库/opencv操作视频保存/机器人左右平移视频.avi");//平移视频
    //VideoCapture video("D:/opencv资料库/opencv操作视频保存/机器人上下左右晃动视频.avi");//上下左右移动视频
    VideoCapture video("D:/opencv资料库/opencv操作视频保存/机器人旋转视频.avi");//旋转视频
    //获取视频参数
